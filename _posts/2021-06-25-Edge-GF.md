...
对这个哈密顿量沿着$x$方向取开边界,沿$y$方向仍然是周期边界条件,这样就可以在一个圆柱结构上计算边界态了.
...
相比较于[利用格林函数求解边界态](https://yxli8023.github.io/2021/02/07/EdgeState-GF.html)中的结果,可以清晰的看到边界态和体态的结果.
