...
## Fd3m
这是一个非点式空间群,处理起来先要区分在陪集分解的时候$P\in{E,C_{3j}^\pm,C_{2m},\sigma_{dp},S_{4m}^\pm}$的时候,平移部分$\mathbf{w}_i=0$,当$Q\in{I,S_{6j}^\mp,\sigma_m,C_{2p},C_{4m}^\pm}$的时候平移部分$\mathbf{w}_j=\mathbf{v}=\frac{1}{4}(a,a,a)$.
