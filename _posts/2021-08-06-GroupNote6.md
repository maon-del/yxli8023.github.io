...
$$\begin{equation}\begin{aligned}&[t_\alpha]-1=t_\alpha,\quad [t_1]_\alpha=t_1,\quad r_{\alpha 1}=r_{1\alpha}=r_\alpha,\quad t_{\alpha 1}=t_{1\alpha}=t_1\\ &[t_a]_\alpha[t_b]_\alpha=[t_at_b]_\alpha,\quad [t_a^{-1}]_\alpha=([t_a]_\alpha)^{-1}\end{akigned}\end{equation}$$
